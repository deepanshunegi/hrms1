    ...
    $(document).ready(function () {
        ...
        form.children(".wizard").steps({
            ...
            onFinished: function (event, currentIndex) {
                ...
                var emp_name = emp_name.charAt(0).toUpperCase()+emp_name.slice(1);
                ...
                //alert("first date value set her "+date_of_birth);
                // var datepicker4 = $('#datepicker4').val();
                var date_of_joining = $('.doj').val();
              //  alert("second date value set her "+date_of_joining);
                ...
                var date_of_confirmation = $('.doc').val();
                //alert("third date value set her "+date_of_confirmation);
                ...
                var date_of_resignation = $('.dor').val();
                //alert("date of Resignation "+date_of_resignation);

                var last_working_day = $('.lwd').val();
                //alert("date of Resignation "+last_working_day);
                ...
                formData.append('date_of_confirmation', date_of_confirmation);
                ...
                formData.append('date_of_resignation', date_of_resignation);
                ...
                var url = $('#url').val();
              //  alert("Hello form date ");
                //console.log("****************Deepanshu Testing*****************");
