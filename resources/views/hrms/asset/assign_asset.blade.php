                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                {{--@if(\Route::getFacadeRoot()->current()->uri() == 'edit-assignment/{id}')
                                                    ...
                                                    <input type="text" id="datepicker1" class="select2-single form-control" name="dor" value="@if($emps && $emps->dor){{$emps->dor}}@endif"/>

                                                @else

                                                    <input type="text" id="datepicker1" class="select2-single form-control" name="dor"/>
