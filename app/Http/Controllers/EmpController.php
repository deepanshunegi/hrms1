...
class EmpController extends Controller
{
    ...
    public function processEmployee(Request $request)
    {
      //   print_r($request->all());
        ...
        $emp->date_of_birth        = isset($request->date_of_birth) ? date("Y-m-d H:i:s", strtotime($request->date_of_birth)) : '0000-00-00';
        $emp->date_of_joining      = isset($request->date_of_joining) ? date("Y-m-d H:i:s", strtotime($request->date_of_joining)) : '0000-00-00';
        ...
        $emp->date_of_confirmation = isset($request->date_of_confirmation) ? date("Y-m-d H:i:s", strtotime($request->date_of_confirmation)) : '0000-00-00';
        ...
        $emp->date_of_resignation  = isset($request->date_of_resignation) ? date("Y-m-d H:i:s", strtotime($request->date_of_resignation)) : '0000-00-00';
        $emp->notice_period        = $request->notice_period;
        $emp->last_working_day     = isset($request->last_working_day) ? date("Y-m-d H:i:s", strtotime($request->last_working_day)) : '0000-00-00';
