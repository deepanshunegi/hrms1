                                    ...
                                    <table class="table allcp-form theme-warning tc-checkbox-1 fs13">
                                        ...
                                        <?php $__currentLoopData = $emps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td class="text-center"><?php echo e($emp->employee['pf_account_number']); ?></td>
                                                <td class="text-center">
                                                    <div class="btn-group text-right">
                                                        <button type="button"
                                                                class="btn btn-success br2 btn-xs fs12 showModal"
                                                                data-info='[
                                                                "<?php echo e($emp->employee['id']); ?>",
                                                                "<?php echo e($emp->employee['name']); ?>",
                                                                "<?php echo e($emp->employee['bank_name']); ?>",
                                                                "<?php echo e($emp->employee['account_number']); ?>",
                                                                "<?php echo e($emp->employee['ifsc_code']); ?>",
                                                                "<?php echo e($emp->employee['pf_account_number']); ?>"
                                                                ]'> Edit
                                                        </button>
                                                    </div>
                                                </td>
