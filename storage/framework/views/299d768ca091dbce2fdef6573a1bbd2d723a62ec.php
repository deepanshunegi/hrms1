...
<head>
    ...
    <!-- -------------- Icomoon -------------- -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/assets/fonts/icomoon/icomoon.css')); ?>">

    <!-- -------------- FullCalendar -------------- -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/assets/js/plugins/fullcalendar/fullcalendar.min.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/assets/js/plugins/magnific/magnific-popup.css')); ?>">

    <!-- -------------- Plugins -------------- -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/assets/js/plugins/c3charts/c3.min.css')); ?>">

    <!-- -------------- CSS - theme -------------- -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/assets/skin/default_skin/css/theme.css')); ?>">


    <!-- -------------- CSS - allcp forms -------------- -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/assets/allcp/forms/css/forms.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/assets/allcp/forms/css/widget.css')); ?>">

    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/assets/js/plugins/select2/css/core.css')); ?>">
    <!-- -------------- Favicon -------------- -->
    <link rel="shortcut icon" href="<?php echo e(asset('public/assets/img/favicon.png')); ?>">

    <!--  Custom css -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/assets/custom.css')); ?>">

    <!-- Sweet alert -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/assets/sweetalert.css')); ?>">

    <!-- -------------- jQuery -------------- -->
<script src="<?php echo e(asset('public/assets/js/jquery/jquery-1.11.3.min.js')); ?>"></script>

<script src="<?php echo e(asset('public/assets/js/jquery/jquery_ui/jquery-ui.min.js')); ?>"></script>
...
<!-- -------------- HighCharts Plugin -------------- -->
<script src="<?php echo e(asset('public/assets/js/plugins/highcharts/highcharts.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/js/plugins/c3charts/d3.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/js/plugins/c3charts/c3.min.js')); ?>"></script>

<!-- -------------- Simple Circles Plugin -------------- -->
<script src="<?php echo e(asset('public/assets/js/plugins/circles/circles.js')); ?>"></script>

<!-- -------------- Maps JSs -------------- -->
<script src="<?php echo e(asset('public/assets/js/plugins/jvectormap/jquery.jvectormap.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/js/plugins/jvectormap/assets/jquery-jvectormap-us-lcc-en.js')); ?>"></script>

<!-- -------------- FullCalendar Plugin -------------- -->
<script src="<?php echo e(asset('public/assets/js/plugins/fullcalendar/lib/moment.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/js/plugins/fullcalendar/fullcalendar.min.js')); ?>"></script>

<!-- -------------- Date/Month - Pickers -------------- -->
<script src="<?php echo e(asset('public/assets/allcp/forms/js/jquery-ui-monthpicker.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/allcp/forms/js/jquery-ui-datepicker.min.js')); ?>"></script>

<!-- -------------- Magnific Popup Plugin -------------- -->
<script src="<?php echo e(asset('public/assets/js/plugins/magnific/jquery.magnific-popup.js')); ?>"></script>

<!-- -------------- Theme Scripts -------------- -->
<script src="<?php echo e(asset('public/assets/js/utility/utility.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/js/demo/demo.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/js/main.js')); ?>"></script>

<!-- -------------- Widget JS -------------- -->
<script src="<?php echo e(asset('public/assets/js/demo/widgets.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/js/demo/widgets_sidebar.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/js/pages/dashboard1.js')); ?>"></script>

<!-- Sweet alert -->
<script src="<?php echo e(asset('public/assets/js/sweetalert.min.js')); ?>"></script>
...
<script src="<?php echo e(asset('public/assets/js/pages/allcp_forms-elements.js')); ?>"></script>
