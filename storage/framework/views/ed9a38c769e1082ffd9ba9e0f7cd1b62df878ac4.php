                            ...
                            <div class="panel-body table-responsive">
                                <div class="form-horizontal">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                        <?php $i =0;?>
                                        <?php $__currentLoopData = $filenames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $holiday): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <td class="text-center"><?php echo e($i+=1); ?></td>
                                            <td class="text-center"><?php echo e($holiday->name); ?></td>
                                            <td class="text-center"><?php echo e($holiday->description); ?></td>
                                            <td class="text-center"><?php echo e($holiday->date); ?></td>
                                        </tbody>
